...
- (void)createFlowerData {
	...
	[redFlowers addObject:[[NSDictionary alloc]
						   initWithObjectsAndKeys:@"罂粟目",@"name",
						   @"poppy.png",@"picture",
						   @"http://zh.wikipedia.org/wiki/罂粟目",@"url",nil]];
	[redFlowers addObject:[[NSDictionary alloc]
						   initWithObjectsAndKeys:@"郁金香",@"name",
						   @"tulip.png",@"picture",
						   @"http://zh.wikipedia.org/wiki/郁金香",@"url",nil]];
	[redFlowers addObject:[[NSDictionary alloc]
						   initWithObjectsAndKeys:@"非洲菊",@"name",
						   @"gerbera.png",@"picture",
						   @"http://zh.wikipedia.org/wiki/非洲菊",@"url",nil]];
	[redFlowers addObject:[[NSDictionary alloc]
						   initWithObjectsAndKeys:@"芍药属",@"name",
						   @"peony.png",@"picture",
						   @"http://zh.wikipedia.org/wiki/芍药属",@"url",nil]];
	[redFlowers addObject:[[NSDictionary alloc]
						   initWithObjectsAndKeys:@"蔷薇属",@"name",
						   @"rose.png",@"picture",
						   @"http://zh.wikipedia.org/wiki/蔷薇属",@"url",nil]];
	[redFlowers addObject:[[NSDictionary alloc]
